<?php
    // file: staff_submitted_forms.php
    session_start();
    ...
    if ($_SESSION['userType'] == 'Staff'){
        $_SESSION['htmlTitle'] =  "My students";
        try
        {
            ...
            require_once 'Staff/php/StaffMyStudents.php';//connects to the main Home scripit and page section for Admin
