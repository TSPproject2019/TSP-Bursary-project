<?php
    // file: staff_student_history.php
    session_start();
    ...
    if ($_SESSION['userType'] == 'Staff'){
        $_SESSION['htmlTitle'] =  "History of student requests";
        try
        {
            ...
            require_once 'Staff/php/StaffStudentHistory.php';//connects to the main Home scripit and page section for Admin
