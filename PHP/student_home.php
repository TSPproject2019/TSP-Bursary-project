<?php
    ...
    try
    {
        ...
        require_once 'Staff/php/StudentHome.php';//connects to the main Home scripit and page section for Admin
        require_once 'Staff/php/StudentFooter.php';//connects to the footer section for all pages for Admin
    }
